...
template <class FieldType>
void prepareFTsource(Field<FieldType> &phi, Field<FieldType> &chi, Field<FieldType> &source,
					 const FieldType bgmodel, Field<FieldType> &result, const double coeff, const double coeff2, const double coeff3)
{
	Site x(phi.lattice());
...
void evolveFTvector(Field<Cplx> &SijFT, Field<Cplx> &BiFT, const Real a2dtau)
{
	...
	for (; k.test(); k.next())
	{
		...
		BiFT(k, 0) += Cplx(0., -2. * a2dtau / k4) * (kshift[k.coord(0)].conj() * ((gridk2[k.coord(1)] + gridk2[k.coord(2)]) * SijFT(k, 0, 0) - gridk2[k.coord(1)] * SijFT(k, 1, 1) - gridk2[k.coord(2)] * SijFT(k, 2, 2) - 2. * kshift[k.coord(1)] * kshift[k.coord(2)] * SijFT(k, 1, 2)) + (gridk2[k.coord(1)] + gridk2[k.coord(2)] - gridk2[k.coord(0)]) * (kshift[k.coord(1)] * SijFT(k, 0, 1) + kshift[k.coord(2)] * SijFT(k, 0, 2)));
		BiFT(k, 1) += Cplx(0., -2. * a2dtau / k4) * (kshift[k.coord(1)].conj() * ((gridk2[k.coord(0)] + gridk2[k.coord(2)]) * SijFT(k, 1, 1) - gridk2[k.coord(0)] * SijFT(k, 0, 0) - gridk2[k.coord(2)] * SijFT(k, 2, 2) - 2. * kshift[k.coord(0)] * kshift[k.coord(2)] * SijFT(k, 0, 2)) + (gridk2[k.coord(0)] + gridk2[k.coord(2)] - gridk2[k.coord(1)]) * (kshift[k.coord(0)] * SijFT(k, 0, 1) + kshift[k.coord(2)] * SijFT(k, 1, 2)));
		BiFT(k, 2) += Cplx(0., -2. * a2dtau / k4) * (kshift[k.coord(2)].conj() * ((gridk2[k.coord(0)] + gridk2[k.coord(1)]) * SijFT(k, 2, 2) - gridk2[k.coord(0)] * SijFT(k, 0, 0) - gridk2[k.coord(1)] * SijFT(k, 1, 1) - 2. * kshift[k.coord(0)] * kshift[k.coord(1)] * SijFT(k, 0, 1)) + (gridk2[k.coord(0)] + gridk2[k.coord(1)] - gridk2[k.coord(2)]) * (kshift[k.coord(0)] * SijFT(k, 0, 2) + kshift[k.coord(1)] * SijFT(k, 1, 2)));
	}
...
void projectFTtensor(Field<Cplx> &SijFT, Field<Cplx> &hijFT)
{
	...
	for (; k.test(); k.next())
	{
		...
		hijFT(k, 0, 0) = ((gridk2[k.coord(0)] - k2) * ((gridk2[k.coord(0)] - k2) * SxxFT + 2. * kshift[k.coord(0)] * (kshift[k.coord(1)] * SxyFT + kshift[k.coord(2)] * SxzFT)) + ((gridk2[k.coord(0)] + k2) * (gridk2[k.coord(1)] + k2) - 2. * k2 * k2) * SyyFT + ((gridk2[k.coord(0)] + k2) * (gridk2[k.coord(2)] + k2) - 2. * k2 * k2) * SzzFT + 2. * (gridk2[k.coord(0)] + k2) * kshift[k.coord(1)] * kshift[k.coord(2)] * SyzFT) / k6;

		hijFT(k, 0, 1) = (2. * (gridk2[k.coord(0)] - k2) * (gridk2[k.coord(1)] - k2) * SxyFT + (gridk2[k.coord(2)] + k2) * kshift[k.coord(0)].conj() * kshift[k.coord(1)].conj() * SzzFT + (gridk2[k.coord(0)] - k2) * kshift[k.coord(1)].conj() * (kshift[k.coord(0)].conj() * SxxFT + 2. * kshift[k.coord(2)] * SxzFT) + (gridk2[k.coord(1)] - k2) * kshift[k.coord(0)].conj() * (kshift[k.coord(1)].conj() * SyyFT + 2. * kshift[k.coord(2)] * SyzFT)) / k6;

		hijFT(k, 0, 2) = (2. * (gridk2[k.coord(0)] - k2) * (gridk2[k.coord(2)] - k2) * SxzFT + (gridk2[k.coord(1)] + k2) * kshift[k.coord(0)].conj() * kshift[k.coord(2)].conj() * SyyFT + (gridk2[k.coord(0)] - k2) * kshift[k.coord(2)].conj() * (kshift[k.coord(0)].conj() * SxxFT + 2. * kshift[k.coord(1)] * SxyFT) + (gridk2[k.coord(2)] - k2) * kshift[k.coord(0)].conj() * (kshift[k.coord(2)].conj() * SzzFT + 2. * kshift[k.coord(1)] * SyzFT)) / k6;

		hijFT(k, 1, 1) = ((gridk2[k.coord(1)] - k2) * ((gridk2[k.coord(1)] - k2) * SyyFT + 2. * kshift[k.coord(1)] * (kshift[k.coord(0)] * SxyFT + kshift[k.coord(2)] * SyzFT)) + ((gridk2[k.coord(1)] + k2) * (gridk2[k.coord(0)] + k2) - 2. * k2 * k2) * SxxFT + ((gridk2[k.coord(1)] + k2) * (gridk2[k.coord(2)] + k2) - 2. * k2 * k2) * SzzFT + 2. * (gridk2[k.coord(1)] + k2) * kshift[k.coord(0)] * kshift[k.coord(2)] * SxzFT) / k6;

		hijFT(k, 1, 2) = (2. * (gridk2[k.coord(1)] - k2) * (gridk2[k.coord(2)] - k2) * SyzFT + (gridk2[k.coord(0)] + k2) * kshift[k.coord(1)].conj() * kshift[k.coord(2)].conj() * SxxFT + (gridk2[k.coord(1)] - k2) * kshift[k.coord(2)].conj() * (kshift[k.coord(1)].conj() * SyyFT + 2. * kshift[k.coord(0)] * SxyFT) + (gridk2[k.coord(2)] - k2) * kshift[k.coord(1)].conj() * (kshift[k.coord(2)].conj() * SzzFT + 2. * kshift[k.coord(0)] * SxzFT)) / k6;

		hijFT(k, 2, 2) = ((gridk2[k.coord(2)] - k2) * ((gridk2[k.coord(2)] - k2) * SzzFT + 2. * kshift[k.coord(2)] * (kshift[k.coord(0)] * SxzFT + kshift[k.coord(1)] * SyzFT)) + ((gridk2[k.coord(2)] + k2) * (gridk2[k.coord(0)] + k2) - 2. * k2 * k2) * SxxFT + ((gridk2[k.coord(2)] + k2) * (gridk2[k.coord(1)] + k2) - 2. * k2 * k2) * SyyFT + 2. * (gridk2[k.coord(2)] + k2) * kshift[k.coord(0)] * kshift[k.coord(1)] * SxyFT) / k6;
	}
...
Real update_q_5th(double dtau, double dx, part_simple *part, double *ref_dist, part_simple_info partInfo, Field<Real> **fields, Site *sites, int nfield, double *params, double *outputs, int noutputs)
{
#define phi (*fields[0])
#define chi (*fields[1])
#define Bi (*fields[2])
#define achi (*fields[3])
#define xphi (sites[0])
#define xchi (sites[1])
#define xB (sites[2])
#define xachi (sites[3])
	// modified so that params = [a,BiScale,phi0,M,boxsize]
	...
	if (nfield >= 4 && fields[3] != NULL)
	{
		fac = params[2];
		aphi = ((1 - ref_dist[0]) * (1. - ref_dist[1]) * (1. - ref_dist[2]) * achi(xachi) + ref_dist[0] * (1. - ref_dist[1]) * (1. - ref_dist[2]) * achi(xachi + 0) + (1 - ref_dist[0]) * ref_dist[1] * (1. - ref_dist[2]) * achi(xachi + 1) + ref_dist[0] * ref_dist[1] * (1. - ref_dist[2]) * achi(xachi + 0 + 1) + (1 - ref_dist[0]) * (1. - ref_dist[1]) * ref_dist[2] * achi(xachi + 2) + ref_dist[0] * (1. - ref_dist[1]) * ref_dist[2] * achi(xachi + 2 + 0) + (1 - ref_dist[0]) * ref_dist[1] * ref_dist[2] * achi(xachi + 2 + 1) + ref_dist[0] * ref_dist[1] * ref_dist[2] * achi(xachi + 2 + 0 + 1)) * fac;
		daphix = fac * ((1. - ref_dist[1]) *
							(1. - ref_dist[2]) * (achi(xachi + 0) - achi(xachi)) +
						ref_dist[1] * (1. - ref_dist[2]) * (achi(xachi + 1 + 0) - achi(xachi + 1)) + (1. - ref_dist[1]) * ref_dist[2] * (achi(xachi + 2 + 0) - achi(xachi + 2)) + ref_dist[1] * ref_dist[2] * (achi(xachi + 2 + 1 + 0) - achi(xachi + 2 + 1)));
		daphiy = fac * ((1. - ref_dist[0]) * (1. - ref_dist[2]) * (achi(xachi + 1) - achi(xachi)) + ref_dist[0] * (1. - ref_dist[2]) * (achi(xachi + 1 + 0) - achi(xachi + 0)) + (1. - ref_dist[0]) * ref_dist[2] * (achi(xachi + 2 + 1) - achi(xachi + 2)) + ref_dist[0] * ref_dist[2] * (achi(xachi + 2 + 1 + 0) - achi(xachi + 2 + 0)));
		daphiz = fac * ((1. - ref_dist[0]) * (1. - ref_dist[1]) * (achi(xachi + 2) - achi(xachi)) + ref_dist[0] * (1. - ref_dist[1]) * (achi(xachi + 2 + 0) - achi(xachi + 0)) + (1. - ref_dist[0]) * ref_dist[1] * (achi(xachi + 2 + 1) - achi(xachi + 1)) + ref_dist[0] * ref_dist[1] * (achi(xachi + 2 + 1 + 0) - achi(xachi + 1 + 0)));

		gradphi[0] = -aphi * daphix;
		gradphi[1] = -aphi * daphiy;
		gradphi[2] = -aphi * daphiz;
	...
	if (nfield >= 2 && fields[1] != NULL) // chi-field
	{
		...
		gradphi[0] += 2.0 * aphi * daphix;
		gradphi[1] += 2.0 * aphi * daphiy;
		gradphi[2] += 2.0 * aphi * daphiz;
	}

	e2 = sqrt(e2);

	if (nfield >= 3 && fields[2] != NULL) // B-field
	{
		...
		gradphi[0] += pgradB[0] / e2 / params[1];
		gradphi[1] += pgradB[1] / e2 / params[1];
		gradphi[2] += pgradB[2] / e2 / params[1];
	}
...
Real update_q(double dtau, double dx, part_simple *part, double *ref_dist,
			  ...
			  Site *sites, int nfield, double *params, double *outputs, int noutputs)
{
#define phi (*fields[0])
#define chi (*fields[1])
#define Bi (*fields[2])
...
Real update_q_Newton_5th(double dtau, double dx, part_simple *part, double *ref_dist, part_simple_info partInfo, Field<Real> **fields, Site *sites, int nfield, double *params, double *outputs, int noutputs)
{
#define phi (*fields[0])
#define xphi (sites[0])
#define chi (*fields[1])
#define xchi (sites[1])
#define achi (*fields[2])
#define xachi (sites[2])

	Real gradpsi[3] = {0, 0, 0};
	Real daphix, daphiy, daphiz, fac, aphif, Acnf, dAcnf;
	gradpsi[0] = (1. - ref_dist[1]) * (1. - ref_dist[2]) * (phi(xphi + 0) - phi(xphi));
	gradpsi[1] = (1. - ref_dist[0]) * (1. - ref_dist[2]) * (phi(xphi + 1) - phi(xphi));
	gradpsi[2] = (1. - ref_dist[0]) * (1. - ref_dist[1]) * (phi(xphi + 2) - phi(xphi));
	gradpsi[0] += ref_dist[1] * (1. - ref_dist[2]) * (phi(xphi + 1 + 0) - phi(xphi + 1));
	gradpsi[1] += ref_dist[0] * (1. - ref_dist[2]) * (phi(xphi + 1 + 0) - phi(xphi + 0));
	gradpsi[2] += ref_dist[0] * (1. - ref_dist[1]) * (phi(xphi + 2 + 0) - phi(xphi + 0));
	gradpsi[0] += (1. - ref_dist[1]) * ref_dist[2] * (phi(xphi + 2 + 0) - phi(xphi + 2));
	gradpsi[1] += (1. - ref_dist[0]) * ref_dist[2] * (phi(xphi + 2 + 1) - phi(xphi + 2));
	gradpsi[2] += (1. - ref_dist[0]) * ref_dist[1] * (phi(xphi + 2 + 1) - phi(xphi + 1));
	gradpsi[0] += ref_dist[1] * ref_dist[2] * (phi(xphi + 2 + 1 + 0) - phi(xphi + 2 + 1));
	gradpsi[1] += ref_dist[0] * ref_dist[2] * (phi(xphi + 2 + 1 + 0) - phi(xphi + 2 + 0));
	gradpsi[2] += ref_dist[0] * ref_dist[1] * (phi(xphi + 2 + 1 + 0) - phi(xphi + 1 + 0));
	...
	fac = params[2];
	aphif = ((1 - ref_dist[0]) * (1. - ref_dist[1]) * (1. - ref_dist[2]) * achi(xachi) + ref_dist[0] * (1. - ref_dist[1]) * (1. - ref_dist[2]) * achi(xachi + 0) + (1 - ref_dist[0]) * ref_dist[1] * (1. - ref_dist[2]) * achi(xachi + 1) + ref_dist[0] * ref_dist[1] * (1. - ref_dist[2]) * achi(xachi + 0 + 1) + (1 - ref_dist[0]) * (1. - ref_dist[1]) * ref_dist[2] * achi(xachi + 2) + ref_dist[0] * (1. - ref_dist[1]) * ref_dist[2] * achi(xachi + 2 + 0) + (1 - ref_dist[0]) * ref_dist[1] * ref_dist[2] * achi(xachi + 2 + 1) + ref_dist[0] * ref_dist[1] * ref_dist[2] * achi(xachi + 2 + 0 + 1)) * fac;
	daphix = fac * ((1. - ref_dist[1]) *
						(1. - ref_dist[2]) * (achi(xachi + 0) - achi(xachi)) +
					ref_dist[1] * (1. - ref_dist[2]) * (achi(xachi + 1 + 0) - achi(xachi + 1)) + (1. - ref_dist[1]) * ref_dist[2] * (achi(xachi + 2 + 0) - achi(xachi + 2)) + ref_dist[1] * ref_dist[2] * (achi(xachi + 2 + 1 + 0) - achi(xachi + 2 + 1)));
	daphiy = fac * ((1. - ref_dist[0]) * (1. - ref_dist[2]) * (achi(xachi + 1) - achi(xachi)) + ref_dist[0] * (1. - ref_dist[2]) * (achi(xachi + 1 + 0) - achi(xachi + 0)) + (1. - ref_dist[0]) * ref_dist[2] * (achi(xachi + 2 + 1) - achi(xachi + 2)) + ref_dist[0] * ref_dist[2] * (achi(xachi + 2 + 1 + 0) - achi(xachi + 2 + 0)));
	...
	gradpsi[0] += aphif * daphix;
	gradpsi[1] += aphif * daphiy;
	gradpsi[2] += aphif * daphiz;
...
void update_pos_5th(double dtau, double dx, part_simple *part, double *ref_dist, part_simple_info partInfo, Field<Real> **fields, Site *sites, int nfield, double *params, double *outputs, int noutputs)
{
	Real v[3];
	Real phi = 0.;
	Real chi = 0.;
	...
	if (nfield >= 4)
	{
		// Modification to add effect of conformal coupling on canonical momentum
		fac = params[2]; // phi0/M
		aphi = (*fields[3])(sites[3]) * (1. - ref_dist[0]) * (1. - ref_dist[1]) * (1. - ref_dist[2]);
		aphi += (*fields[3])(sites[3] + 0) * ref_dist[0] * (1. - ref_dist[1]) * (1. - ref_dist[2]);
		aphi += (*fields[3])(sites[3] + 1) * (1. - ref_dist[0]) * ref_dist[1] * (1. - ref_dist[2]);
		aphi += (*fields[3])(sites[3] + 0 + 1) * ref_dist[0] * ref_dist[1] * (1. - ref_dist[2]);
		aphi += (*fields[3])(sites[3] + 2) * (1. - ref_dist[0]) * (1. - ref_dist[1]) * ref_dist[2];
		aphi += (*fields[3])(sites[3] + 0 + 2) * ref_dist[0] * (1. - ref_dist[1]) * ref_dist[2];
		aphi += (*fields[3])(sites[3] + 1 + 2) * (1. - ref_dist[0]) * ref_dist[1] * ref_dist[2];
		aphi += (*fields[3])(sites[3] + 0 + 1 + 2) * ref_dist[0] * ref_dist[1] * ref_dist[2];
		aphi *= fac;
		dAcnf = aphi * aphi / 2.;
		Acnf = 1. + dAcnf;
	}
	...
	if (nfield >= 3)
	{
		...
		for (int l = 0; l < 3; l++)
			(*part).pos[l] += dtau * (v[l] + b[l] / params[1]) * Acnf;
	}
	else
	{
		for (int l = 0; l < 3; l++)
			(*part).pos[l] += dtau * v[l] * Acnf;
	}
}
