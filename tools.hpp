			...
			for (w = -range; w <= range; w++)
			{
				...
				if (vertex[n][0] < domain[0])
				{
					if (vertex[n][1] < domain[1])
					{
						...
						{
							if (sqrt((vertex[n][0] - corner[0][0]) * (vertex[n][0] - corner[0][0]) + (vertex[n][1] - corner[0][1]) * (vertex[n][1] - corner[0][1]) + (vertex[n][2] - corner[0][2]) * (vertex[n][2] - corner[0][2])) > outer)
								continue;
						}
						else if (vertex[n][2] > domain[5])
						{
							if (sqrt((vertex[n][0] - corner[4][0]) * (vertex[n][0] - corner[4][0]) + (vertex[n][1] - corner[4][1]) * (vertex[n][1] - corner[4][1]) + (vertex[n][2] - corner[4][2]) * (vertex[n][2] - corner[4][2])) > outer)
								continue;
						}
						else if (sqrt((vertex[n][0] - domain[0]) * (vertex[n][0] - domain[0]) + (vertex[n][1] - domain[1]) * (vertex[n][1] - domain[1])) > outer)
							continue;
					}
					else if (vertex[n][1] > domain[4])
					{
						if (vertex[n][2] < domain[2])
						{
							if (sqrt((vertex[n][0] - corner[2][0]) * (vertex[n][0] - corner[2][0]) + (vertex[n][1] - corner[2][1]) * (vertex[n][1] - corner[2][1]) + (vertex[n][2] - corner[2][2]) * (vertex[n][2] - corner[2][2])) > outer)
								continue;
						}
						else if (vertex[n][2] > domain[5])
						{
							if (sqrt((vertex[n][0] - corner[6][0]) * (vertex[n][0] - corner[6][0]) + (vertex[n][1] - corner[6][1]) * (vertex[n][1] - corner[6][1]) + (vertex[n][2] - corner[6][2]) * (vertex[n][2] - corner[6][2])) > outer)
								continue;
						}
						else if (sqrt((vertex[n][0] - domain[0]) * (vertex[n][0] - domain[0]) + (vertex[n][1] - domain[4]) * (vertex[n][1] - domain[4])) > outer)
							continue;
					}
					else
					{
						if (vertex[n][2] < domain[2])
						{
							if (sqrt((vertex[n][0] - domain[0]) * (vertex[n][0] - domain[0]) + (vertex[n][2] - domain[2]) * (vertex[n][2] - domain[2])) > outer)
								continue;
						}
						else if (vertex[n][2] > domain[5])
						{
							if (sqrt((vertex[n][0] - domain[0]) * (vertex[n][0] - domain[0]) + (vertex[n][2] - domain[5]) * (vertex[n][2] - domain[5])) > outer)
								continue;
						}
						else if (domain[0] - vertex[n][0] > outer)
							continue;
					}
				}
				else if (vertex[n][0] > domain[3])
				{
					if (vertex[n][1] < domain[1])
					{
						if (vertex[n][2] < domain[2])
						{
							if (sqrt((vertex[n][0] - corner[1][0]) * (vertex[n][0] - corner[1][0]) + (vertex[n][1] - corner[1][1]) * (vertex[n][1] - corner[1][1]) + (vertex[n][2] - corner[1][2]) * (vertex[n][2] - corner[1][2])) > outer)
								continue;
						}
						else if (vertex[n][2] > domain[5])
						{
							if (sqrt((vertex[n][0] - corner[5][0]) * (vertex[n][0] - corner[5][0]) + (vertex[n][1] - corner[5][1]) * (vertex[n][1] - corner[5][1]) + (vertex[n][2] - corner[5][2]) * (vertex[n][2] - corner[5][2])) > outer)
								continue;
						}
						else if (sqrt((vertex[n][0] - domain[3]) * (vertex[n][0] - domain[3]) + (vertex[n][1] - domain[1]) * (vertex[n][1] - domain[1])) > outer)
							continue;
					}
					else if (vertex[n][1] > domain[4])
					{
						if (vertex[n][2] < domain[2])
						{
							if (sqrt((vertex[n][0] - corner[3][0]) * (vertex[n][0] - corner[3][0]) + (vertex[n][1] - corner[3][1]) * (vertex[n][1] - corner[3][1]) + (vertex[n][2] - corner[3][2]) * (vertex[n][2] - corner[3][2])) > outer)
								continue;
						}
						else if (vertex[n][2] > domain[5])
						{
							if (sqrt((vertex[n][0] - corner[7][0]) * (vertex[n][0] - corner[7][0]) + (vertex[n][1] - corner[7][1]) * (vertex[n][1] - corner[7][1]) + (vertex[n][2] - corner[7][2]) * (vertex[n][2] - corner[7][2])) > outer)
								continue;
						}
						else if (sqrt((vertex[n][0] - domain[3]) * (vertex[n][0] - domain[3]) + (vertex[n][1] - domain[4]) * (vertex[n][1] - domain[4])) > outer)
							continue;
					}
					else
					{
						if (vertex[n][2] < domain[2])
						{
							if (sqrt((vertex[n][0] - domain[3]) * (vertex[n][0] - domain[3]) + (vertex[n][2] - domain[2]) * (vertex[n][2] - domain[2])) > outer)
								continue;
						}
						else if (vertex[n][2] > domain[5])
						{
							if (sqrt((vertex[n][0] - domain[3]) * (vertex[n][0] - domain[3]) + (vertex[n][2] - domain[5]) * (vertex[n][2] - domain[5])) > outer)
								continue;
						}
						else if (vertex[n][0] - domain[3] > outer)
							continue;
					}
				}
				else
				{
					if (vertex[n][1] < domain[1])
					{
						if (vertex[n][2] < domain[2])
						{
							if (sqrt((vertex[n][1] - domain[1]) * (vertex[n][1] - domain[1]) + (vertex[n][2] - domain[2]) * (vertex[n][2] - domain[2])) > outer)
								continue;
						}
						else if (vertex[n][2] > domain[5])
						{
							if (sqrt((vertex[n][1] - domain[1]) * (vertex[n][1] - domain[1]) + (vertex[n][2] - domain[5]) * (vertex[n][2] - domain[5])) > outer)
								continue;
						}
						else if (domain[1] - vertex[n][1] > outer)
							continue;
					}
					else if (vertex[n][1] > domain[4])
					{
						if (vertex[n][2] < domain[2])
						{
							if (sqrt((vertex[n][1] - domain[4]) * (vertex[n][1] - domain[4]) + (vertex[n][2] - domain[2]) * (vertex[n][2] - domain[2])) > outer)
								continue;
						}
						else if (vertex[n][2] > domain[5])
						{
							if (sqrt((vertex[n][1] - domain[4]) * (vertex[n][1] - domain[4]) + (vertex[n][2] - domain[5]) * (vertex[n][2] - domain[5])) > outer)
								continue;
						}
						else if (vertex[n][1] - domain[4] > outer)
							continue;
					}
					else if (vertex[n][2] - domain[5] > outer || domain[2] - vertex[n][2] > outer)
						continue;
				}
...
string hourMinSec(double seconds)
{
	...
	snprintf(ptr,20, "%d:%02d:%02d.%d", h, m, s, f);
